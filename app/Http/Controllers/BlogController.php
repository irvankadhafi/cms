...
//        return view('layoutNews', compact('data','category_widget'));
...
//        return view('single', compact('data','category_widget'));
        return view('konten', compact('data','category_widget','tags_widget'));
    }
